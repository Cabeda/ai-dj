...
Comprehensive reference for Sonic Pi, a code-based music creation and live
performance tool built on SuperCollider. Target runtime: Sonic Pi 5 (the
installed engine); the API below is stable across 4.5-5.x.
